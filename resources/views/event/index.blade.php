                    ...
                    <div class="card-body">
                        <div id="deploymentForm">
                            ...
                            <div class="mb-3" id="dailyOptions">
                                ...
                                <input type="number" name="repeat_days" class="form-control" id="dailyInterval" min="1" value="1">
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check day-checkbox">
                                            <input name="monday" class="form-check-input" type="checkbox" value="Mon" id="mon">
                                            <label class="form-check-label" for="mon">Monday</label>
                                        </div>
                                        <div class="form-check day-checkbox">
                                            <input name="tuseday" class="form-check-input" type="checkbox" value="Tue" id="tue">
                                            <label class="form-check-label" for="tue">Tuesday</label>
                                        </div>
                                        <div class="form-check day-checkbox">
                                            <input name="wednesday" class="form-check-input" type="checkbox" value="Wed" id="wed">
                                            <label class="form-check-label" for="wed">Wednesday</label>
                                        </div>
                                        <div class="form-check day-checkbox">
                                            <input name="thursday" class="form-check-input" type="checkbox" value="Thu" id="thu">
                                            <label class="form-check-label" for="thu">Thursday</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-check day-checkbox">
                                            <input name="friday" class="form-check-input" type="checkbox" value="Fri" id="fri">
                                            <label class="form-check-label" for="fri">Friday</label>
                                        </div>
                                        <div class="form-check day-checkbox">
                                            <input name="saturday" class="form-check-input" type="checkbox" value="Sat" id="sat">
                                            <label class="form-check-label" for="sat">Saturday</label>
                                        </div>
                                        <div class="form-check day-checkbox">
                                            <input name="sunday" class="form-check-input" type="checkbox" value="Sun" id="sun">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="eventTimesContainer">
                                    <div class="time-input-group d-flex align-items-center">
                                        ...
                                        <button type="button" class="btn  btn-sm" onclick="removeTimeInput(this)" style="display: none;">Remove</button>
                                    </div>
                                </div>
                            ...
                            <!-- Submit Button -->
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary btn-lg" id="submitBtn" onclick="saveDeploymentStrategy()">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/js/bootstrap.bundle.min.js"></script>
    <script>
        ...
        function initializeTimeOptions() {
            ...
            document.querySelectorAll('select[name="eventTime"]').forEach(select => {
                select.innerHTML = '';
        ...
        function addTimeInput() {
            ...
            newTimeGroup.innerHTML = `
                <select class="form-select me-2" name="eventTime">
        ...
        function updatePreview() {
            ...
            // Update times
            const times = Array.from(document.querySelectorAll('select[name="eventTime"]')).map(select => select.value);
        ...
        function saveDeploymentStrategy() {
            const formData = {
                ...
                dailyInterval: document.getElementById('dailyInterval').value,
                weeklyDays: Array.from(document.querySelectorAll('#weeklyOptions input:checked')).map(cb => cb.value),
                monthlyDays: Array.from(document.querySelectorAll('#monthlyOptions input:checked')).map(cb => cb.value),
                eventTimes: Array.from(document.querySelectorAll('select[name="eventTime"]')).map(select => select.value)
            };

            console.log('Deployment Strategy:', formData);
            alert('Deployment strategy saved! Check console for details.');
        }
        ...
        document.addEventListener('change', function(e) {
            if (e.target.matches('#weeklyOptions input[type="checkbox"]') ||
                ...
                e.target.matches('select[name="eventTime"]')) {
                updatePreview();
            }
        });
